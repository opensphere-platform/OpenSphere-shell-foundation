...
const FOUNDATION_MANUALS = [
  ...
  ['langfuse-operations-ko', 'OpenSphere Langfuse 플러그인 계획 및 운영 안내서', 'langfuse-operations.ko.md', '/pfss/langfuse', ['langfuse', 'llm-observability', 'ai']],
  ['stalwart-operations-ko', 'OpenSphere Stalwart 플러그인 계획 및 운영 안내서', 'stalwart-operations.ko.md', '/pfss/stalwart', ['stalwart', 'mail', 'jmap', 'communication']],
  ['novu-operations-ko', 'OpenSphere Novu 플러그인 계획 및 운영 안내서', 'novu-operations.ko.md', '/pfss/novu', ['novu', 'notification', 'communication']],
  ['mattermost-operations-ko', 'OpenSphere Mattermost 플러그인 계획 및 운영 안내서', 'mattermost-operations.ko.md', '/pfss/mattermost', ['mattermost', 'chatops', 'communication']],
  ['otel-operations-ko', 'OpenSphere OpenTelemetry Collector 플러그인 설치 및 운영 안내서', 'otel-operations.ko.md', '/pfss/otel', ['opentelemetry', 'otlp', 'observability']],
  ['tempo-operations-ko', 'OpenSphere Grafana Tempo 플러그인 계획 및 운영 안내서', 'tempo-operations.ko.md', '/pfss/tempo', ['grafana', 'tempo', 'traces', 'observability']],
  ['loki-operations-ko', 'OpenSphere Grafana Loki 플러그인 계획 및 운영 안내서', 'loki-operations.ko.md', '/pfss/loki', ['grafana', 'loki', 'logs', 'observability']],
  ['grafana-operator-operations-ko', 'OpenSphere Grafana Operator 플러그인 계획 및 운영 안내서', 'grafana-operator-operations.ko.md', '/pfss/grafana-operator', ['grafana', 'dashboards', 'observability']],
  ['ptm-operations-ko', 'OpenSphere .ptm 보호 플러그인 계획 및 운영 안내서', 'ptm-operations.ko.md', '/pfss/ptm', ['ptm', 'velero', 'backup', 'restore']],
  ['argocd-operations-ko', 'OpenSphere Argo CD Delivery 플러그인 계획 및 운영 안내서', 'argocd-operations.ko.md', '/pfss/delivery/argocd', ['argocd', 'gitops', 'delivery']],
  ['crossplane-operations-ko', 'OpenSphere Crossplane Delivery 플러그인 설치 및 운영 안내서', 'crossplane-operations.ko.md', '/pfss/delivery/crossplane', ['crossplane', 'provider', 'delivery']],
