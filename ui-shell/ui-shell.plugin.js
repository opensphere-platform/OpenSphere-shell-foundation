...
const FOUNDATION_MANUALS = [
  ...
  ['syncope-operations-ko', 'OpenSphere Apache Syncope 플러그인 계획 및 운영 안내서', 'syncope-operations.ko.md', '/p/foundation/syncope', ['syncope', 'iga', 'scim', 'identity']],
  ['opa-operations-ko', 'OpenSphere OPA 플러그인 계획 및 운영 안내서', 'opa-operations.ko.md', '/p/foundation/opa', ['opa', 'policy', 'authorization']],
  ['litellm-operations-ko', 'OpenSphere LiteLLM 플러그인 계획 및 운영 안내서', 'litellm-operations.ko.md', '/p/foundation/litellm', ['litellm', 'llm', 'ai']],
  ['langfuse-operations-ko', 'OpenSphere Langfuse 플러그인 계획 및 운영 안내서', 'langfuse-operations.ko.md', '/p/foundation/langfuse', ['langfuse', 'llm-observability', 'ai']],
  ['stalwart-operations-ko', 'OpenSphere Stalwart 플러그인 계획 및 운영 안내서', 'stalwart-operations.ko.md', '/p/foundation/stalwart', ['stalwart', 'mail', 'jmap', 'communication']],
  ['novu-operations-ko', 'OpenSphere Novu 플러그인 계획 및 운영 안내서', 'novu-operations.ko.md', '/p/foundation/novu', ['novu', 'notification', 'communication']],
  ['mattermost-operations-ko', 'OpenSphere Mattermost 플러그인 계획 및 운영 안내서', 'mattermost-operations.ko.md', '/p/foundation/mattermost', ['mattermost', 'chatops', 'communication']],
  ['otel-operations-ko', 'OpenSphere OpenTelemetry Collector 플러그인 설치 및 운영 안내서', 'otel-operations.ko.md', '/p/foundation/otel', ['opentelemetry', 'otlp', 'observability']],
  ['tempo-operations-ko', 'OpenSphere Grafana Tempo 플러그인 계획 및 운영 안내서', 'tempo-operations.ko.md', '/p/foundation/tempo', ['grafana', 'tempo', 'traces', 'observability']],
  ['loki-operations-ko', 'OpenSphere Grafana Loki 플러그인 계획 및 운영 안내서', 'loki-operations.ko.md', '/p/foundation/loki', ['grafana', 'loki', 'logs', 'observability']],
  ['grafana-operator-operations-ko', 'OpenSphere Grafana Operator 플러그인 계획 및 운영 안내서', 'grafana-operator-operations.ko.md', '/p/foundation/grafana-operator', ['grafana', 'dashboards', 'observability']],
  ['ptm-operations-ko', 'OpenSphere .ptm 보호 플러그인 계획 및 운영 안내서', 'ptm-operations.ko.md', '/p/foundation/ptm', ['ptm', 'velero', 'backup', 'restore']],
