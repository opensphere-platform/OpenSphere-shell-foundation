# OpenSphere Argo CD Delivery Operator 운영 안내서

## 1. 상태와 역할
Operator 계약이 등록되어 있으며 현재 lifecycle은 FoundationModel의 desired/observed 상태로 결정됩니다. Git repository의 서명된 desired state를 target cluster에 동기화하는 Foundation 기본 write-path입니다.
