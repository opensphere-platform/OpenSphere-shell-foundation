...
export const FOUNDATION_PLUGINS: HostedPlugin[] = [
  ...
  },
  {
    ...
    healthRef: 'declared', model: 'identity', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'apache-syncope', element: 'osp-foundation-apache-syncope', installModule: 'modules', installTab: 'syncope' },
  },
  {
    ...
    healthRef: 'declared', model: 'identity', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'opa', element: 'osp-foundation-opa', installModule: 'modules', installTab: 'opa' },
  },
  {
    ...
    healthRef: 'declared', model: 'ai', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'litellm', element: 'osp-foundation-litellm', installModule: 'modules', installTab: 'litellm' },
  },
  {
    ...
    healthRef: 'declared', model: 'ai', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'langfuse', element: 'osp-foundation-langfuse', installModule: 'modules', installTab: 'langfuse' },
  },
  {
    ...
    healthRef: 'declared', model: 'communication', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'stalwart', element: 'osp-foundation-stalwart', installModule: 'modules', installTab: 'stalwart' },
  },
  {
    ...
    healthRef: 'declared', model: 'communication', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'novu', element: 'osp-foundation-novu', installModule: 'modules', installTab: 'novu' },
  },
  {
    ...
    healthRef: 'declared', model: 'communication', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'mattermost', element: 'osp-foundation-mattermost', installModule: 'modules', installTab: 'mattermost' },
  },
  {
    ...
    healthRef: 'declared', model: 'observability', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'opentelemetry', element: 'osp-foundation-opentelemetry', installModule: 'modules', installTab: 'otel' },
  },
  {
    ...
    healthRef: 'declared', model: 'observability', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'grafana-tempo', element: 'osp-foundation-grafana-tempo', installModule: 'modules', installTab: 'tempo' },
  },
  {
    ...
    healthRef: 'declared', model: 'observability', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'grafana-loki', element: 'osp-foundation-grafana-loki', installModule: 'modules', installTab: 'loki' },
  },
  {
    ...
    healthRef: 'declared', model: 'observability', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'grafana-operator', element: 'osp-foundation-grafana-operator', installModule: 'modules', installTab: 'grafana-operator' },
  },
  {
    ...
    healthRef: 'declared', model: 'backup', view: { module: 'modules' }, surface: PG_SURFACE,
    activation: { packageId: 'ptm', element: 'osp-foundation-ptm', installModule: 'modules', installTab: 'ptm' },
  },
  {
