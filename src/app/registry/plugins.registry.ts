...
export const FOUNDATION_PLUGINS: HostedPlugin[] = [
  {
    id: 'postgres', name: 'PostgreSQL', icon: 'db', kind: 'plugin', hostRef: 'foundation', lifecycle: 'registry-backed',
  ...
  {
    id: 'psmdb', name: 'Percona PSMDB', icon: 'db', kind: 'plugin', hostRef: 'foundation', lifecycle: 'registry-backed',
  ...
  {
    id: 'valkey', name: 'Valkey', icon: 'db', kind: 'plugin', hostRef: 'foundation', lifecycle: 'registry-backed',
  ...
  {
    id: 'opensearch', name: 'OpenSearch', icon: 'search', kind: 'plugin', hostRef: 'foundation', lifecycle: 'registry-backed',
  ...
  {
    id: 'rustfs', name: 'RustFS', icon: 'storage', kind: 'plugin', hostRef: 'foundation', lifecycle: 'registry-backed',
  ...
  {
    id: 'syncope', name: 'Apache Syncope', icon: 'users', kind: 'plugin', hostRef: 'foundation', lifecycle: 'registry-backed',
  ...
  {
    id: 'opa', name: 'Open Policy Agent', icon: 'key', kind: 'plugin', hostRef: 'foundation', lifecycle: 'registry-backed',
  ...
  {
    id: 'litellm', name: 'LiteLLM', icon: 'search', kind: 'plugin', hostRef: 'foundation', lifecycle: 'planned',
  ...
  {
    id: 'langfuse', name: 'Langfuse', icon: 'search', kind: 'plugin', hostRef: 'foundation', lifecycle: 'planned',
  ...
  {
    id: 'stalwart', name: 'Stalwart Mail Server', icon: 'users', kind: 'plugin', hostRef: 'foundation', lifecycle: 'planned',
  ...
  {
    id: 'novu', name: 'Novu', icon: 'users', kind: 'plugin', hostRef: 'foundation', lifecycle: 'planned',
  ...
  {
    id: 'mattermost', name: 'Mattermost', icon: 'users', kind: 'plugin', hostRef: 'foundation', lifecycle: 'planned',
  ...
  {
    id: 'otel', name: 'OpenTelemetry Collector', icon: 'search', kind: 'plugin', hostRef: 'foundation', lifecycle: 'planned',
  ...
  {
    id: 'tempo', name: 'Grafana Tempo', icon: 'search', kind: 'plugin', hostRef: 'foundation', lifecycle: 'planned',
  ...
  {
    id: 'loki', name: 'Grafana Loki', icon: 'search', kind: 'plugin', hostRef: 'foundation', lifecycle: 'planned',
  ...
  {
    id: 'grafana-operator', name: 'Grafana Operator', icon: 'search', kind: 'plugin', hostRef: 'foundation', lifecycle: 'planned',
  ...
  {
    id: 'ptm', name: '.ptm / Velero', icon: 'storage', kind: 'plugin', hostRef: 'foundation', lifecycle: 'planned',
  ...
  {
    id: 'argocd', name: 'Argo CD / ApplicationSet', icon: 'storage', kind: 'plugin', hostRef: 'foundation', lifecycle: 'host-integration',
  ...
  {
    id: 'crossplane', name: 'Crossplane', icon: 'storage', kind: 'plugin', hostRef: 'foundation', lifecycle: 'host-integration',
