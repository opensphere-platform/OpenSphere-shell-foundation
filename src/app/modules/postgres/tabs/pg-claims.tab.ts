...
@Component({
  ...
  template: `
    <p class="os-sub">PostgresClaim — 선언만 하면 전용 StackGres SGCluster·DB·role·연결 Secret을 발급합니다 (provisioning.opensphere.io/v1beta1). 기존 CloudNativePG claim도 같은 목록에서 구분해 확인합니다.</p>
