...
type Impl = 'registry-backed' | 'migration-required' | 'planned';
const IMPL_LABEL: Record<Impl, string> = {
  'registry-backed': 'Registry 연동',
  'migration-required': '계약 이관 필요',
  planned: '계획',
};
const IMPL_PILL: Record<Impl, string> = {
  'registry-backed': 'label-success',
  'migration-required': 'label-warning',
  planned: 'label-info',
};
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ClarityModule, PluginPageHeaderComponent],
  template: `
    ...
    <section class="hc-section" *ngFor="let section of sections">
      ...
      <div class="hc-grid">
        <div class="hc-card" *ngFor="let c of cardsFor(section.id)"
             [class.hc-clickable]="c.detail && c.impl === 'registry-backed'" (click)="c.detail && c.impl === 'registry-backed' && open(c)"
             [attr.role]="c.detail && c.impl === 'registry-backed' ? 'button' : null" [attr.tabindex]="c.detail && c.impl === 'registry-backed' ? 0 : null"
             (keydown.enter)="c.detail && c.impl === 'registry-backed' && open(c)">
          <div class="hc-head">
            <div class="hc-logo">
            ...
            <div class="hc-idblock">
              <div class="hc-name">{{ c.name }}<span *ngIf="c.detail && c.impl === 'registry-backed'" class="hc-open">관리 →</span></div>
...
export class FoundationEnginesComponent {
  ...
  readonly cards: EngineCard[] = [
    ...
    },
    {
      ...
      category: 'identity', impl: 'registry-backed', liveKey: 'syncope',
    ...
    },
    {
      ...
      category: 'identity', impl: 'registry-backed', liveKey: 'samba',
    ...
    },
    {
      ...
      category: 'identity', impl: 'registry-backed', liveKey: 'opa',
    ...
    },
    {
      ...
      category: 'data', impl: 'registry-backed', liveKey: 'postgres',
    ...
    },
    {
      ...
      category: 'data', impl: 'registry-backed', liveKey: 'psmdb',
    ...
    },
    {
      ...
      category: 'data', impl: 'registry-backed', liveKey: 'valkey',
    ...
    },
    {
      ...
      category: 'data', impl: 'registry-backed', liveKey: 'rustfs',
    ...
    },
    {
      ...
      category: 'ai', impl: 'planned', liveKey: '',
    ...
    },
    {
      ...
      category: 'comm', impl: 'planned', liveKey: '',
    ...
    },
    {
      ...
      category: 'observability', impl: 'planned', liveKey: '',
    ...
    },
    {
      ...
      category: 'backup', impl: 'planned', liveKey: '',
